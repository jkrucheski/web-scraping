...
(async () => {
    ...
    const browser = await puppeteer.launch({    // Abre una instancia de chromium pero sin interfaz
    ...
    const urls = await page.evaluate(() =>      // El código dentro de evaluete se ejecuta como si estuviéramos en la consola de Scraping
        Array.from(
